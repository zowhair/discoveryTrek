...
export default function BookNowForm({productPath}: any) {
    ...
    const slugString = productPath.split('/')[productPath.split('/').length - 1]
...
return(
        <div className="booknow responsive margin-bottom_top">
            {
                !mailSubmitted ? 
                ...
                <div className="continer">
                    <div className="justify-content">
                        <div className="space-between">
                            <h3 className="h3">Book {packageName}</h3>
                        </div>
